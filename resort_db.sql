...
INSERT INTO `customers` VALUES (9,'John','Doe','john-doe@gamil.com',123123337,0.00,2,'WhoAmI',1,1);
...
CREATE TABLE `detail_trans` (
  ...
  KEY `FK_transaction_det_idx` (`trans_id`),
  CONSTRAINT `FK_transaction_det` FOREIGN KEY (`trans_id`) REFERENCES `transactions` (`trans_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2024-02-27 19:01:46
